...
\jd{The writing style needs to be tightened. For example, this last s.~could just be dropped. I can do a stylistic edit if you want at the next revision.}
...
\jd{Explain that this is the extinction probability starting from a single individual at the count point}.
