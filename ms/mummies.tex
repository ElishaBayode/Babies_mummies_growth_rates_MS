...
%\jd{It would be nice to have a suitably old citation here -- Bartlett or Bailey I guess.}
...
\begin{itemize}
	...
	%\jd{This is long and indirect; why should we imagine that the general population is all in the same stage. I feel we could just write $y_l^{N^l} y_e^{N^e} y_o^{N^o}$ directly, and then explain the $N$s.}
